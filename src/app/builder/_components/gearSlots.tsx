...
export const barbarianGearSlots: GearSlotType[] = [
  ...
  {
    label: 'Dual-Wield Weapon 1',
    value: 'dual_wield_weapon_1',
    imageSrc: '/images/icons/gear/dual_wield_weapon_1.webp',
  },
  {
    label: 'Dual-Wield Weapon 2',
    value: 'dual_wield_weapon_2',
    imageSrc: '/images/icons/gear/dual_wield_weapon_2.webp',
  },
